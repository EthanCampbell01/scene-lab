...
Prompt an AI model (local or cloud) with a short story brief

Generate a structured branching narrative

Validate and repair the model output

Ensure it matches the required JSON schema

Save the result to disk for inspection

Automatically copy it to the previewer as latest.json
